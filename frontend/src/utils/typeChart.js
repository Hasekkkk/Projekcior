export const ALL_TYPES = [
  ...
  // Skuteczność ataku (wiersz) na obrońcę (kolumna)
  // Jeśli jakiegoś typu tu nie ma, mnożnik wynosi domyślnie 1.
  ...
  // Funkcja kalkulująca (Atakujący Typ -> Pokemon obrońcy i jego typy)
